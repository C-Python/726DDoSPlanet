...
/*
 726 DDoS tool on <strike>steroids</strike> goroutines. Just ported from Python with some improvements.
 Original Python utility by Berat.Z aKa CyberPython http://www.sectorix.com/2012/05/17/hulk-web-server-dos-tool/

 This go program licensed under GNU Lesser.
 Copyright Berat Zendeli <pythondella@gmail.com>
*/
...
func main() {
	...
	go func() {
		fmt.Println("-- 726 Nisemi Per Ne Toke --\n           Go!\n\n")
